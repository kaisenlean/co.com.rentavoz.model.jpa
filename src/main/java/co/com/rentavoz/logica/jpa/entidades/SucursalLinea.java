...
public class SucursalLinea implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.idSucursalLinea == null && other.idSucursalLinea != null) || (this.idSucursalLinea != null && !this.idSucursalLinea.equals(other.idSucursalLinea))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.invte.rentavoz.logica.entidades.SucursalLinea[ idSucursalLinea=" + idSucursalLinea + " ]";
    }
