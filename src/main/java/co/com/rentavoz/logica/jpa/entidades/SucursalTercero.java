...
public class SucursalTercero implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.idSucursalTercero == null && other.idSucursalTercero != null) || (this.idSucursalTercero != null && !this.idSucursalTercero.equals(other.idSucursalTercero))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.invte.rentavoz.logica.entidades.SucursalTercero[ idSucursalTercero=" + idSucursalTercero + " ]";
    }
