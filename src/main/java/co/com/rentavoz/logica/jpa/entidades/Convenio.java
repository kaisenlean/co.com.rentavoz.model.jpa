...
public class Convenio implements Serializable {
    ...
    public Convenio(Integer idConvenio, short conComision, Date conFechaInicio, short conValorFijo, int conEstado) {
        this.idConvenio = idConvenio;
    ...
    public String toString() {
        return "com.invte.rentavoz.logica.entidades.Convenio[ idConvenio=" + idConvenio + " ]";
    }
