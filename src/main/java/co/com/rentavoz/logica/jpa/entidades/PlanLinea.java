...
public class PlanLinea implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.idPlanLinea == null && other.idPlanLinea != null) || (this.idPlanLinea != null && !this.idPlanLinea.equals(other.idPlanLinea))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.invte.rentavoz.logica.entidades.PlanLinea[ idPlanLinea=" + idPlanLinea + " ]";
    }
